...
/**
 * Allows plugin to use its update API.
 *
 * @author NFT Memberships
 * @version 0.0.1
 */
class Updater {
	...
	public function __construct( $_api_url, $_plugin_file, $_api_data = null ) {
		...
		$this->cache_key   = 'wp_em_ua_updater_edd_sl_' . md5( serialize( $this->slug . $this->api_data['license'] . $this->beta ) );
