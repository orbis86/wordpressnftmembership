<?php
/**
 * Administration API: NFT_Memberships_List_Table class
 *
...
class Base_List_Table {
	...
	public function ajax_user_can() {
		die( 'function NFT_Memberships_List_Table::ajax_user_can() must be overridden in a subclass.' );
	}
	...
	/**
	 * Public wrapper for NFT_Memberships_List_Table::get_default_primary_column_name().
	 *
	...
	public function get_columns() {
		die( 'function NFT_Memberships_List_Table::get_columns() must be overridden in a subclass.' );
	}
	...
	/**
	 * Gets a list of CSS classes for the NFT_Memberships_List_Table table tag.
	 *
	 ...
	 *
	 * @uses Base_List_Table::set_pagination_args()
	 *
	 * @since 1.0.0
	 * @abstract
	 */
	public function prepare_items() {
		die( 'function NFT_Memberships_List_Table::prepare_items() must be overridden in a subclass.' );
	}
